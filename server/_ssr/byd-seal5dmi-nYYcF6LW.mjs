...
import { d as SLUG$6, P as PageShell } from "./router-B48uk9Ad.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { g as getInstallmentModel, c as calcInstallment, f as formatBaht, h as colorWhite } from "./models-XtFHhd1I.mjs";
import { T as TestDriveForm } from "./TestDriveForm-DQQQiv-o.mjs";
import { InstallmentCalculator } from "./InstallmentCalculator-ZYE1yCzZ.mjs";
...
const frontGrille = "/assets/frontGrille-i6wDUetd.webp";
const ledFront = "/assets/ledFront-DkBD0Q5L.webp";
const ledBack = "/assets/ledBack-BslXNJ6g.webp";
const wheels = "/assets/wheels-qkg3W4dk.webp";
const chargingPort = "/assets/chargingPort-DoOXSh4E.webp";
const chargingTool = "/assets/chargingTool-DResPu20.webp";
const premiumDesign = "/assets/premiumDesign-CXB-s_pz.webp";
const consoleImage = "/assets/console-B-ZbUhRx.webp";
const monitorImage = "/assets/monitor-DvyVx9__.webp";
const seatImage = "/assets/seat-DSTCU6dD.webp";
const armrestImage = "/assets/armrest-CDLdZJh3.webp";
const storageImage = "/assets/storage-72T9kTR-.webp";
...
const EXTERIOR_GALLERY = [
  { title: "กระจังหน้า Dot Matrix", image: frontGrille },
  { title: "ไฟหน้า Full LED Starlight", image: ledFront },
  { title: "ไฟท้าย Full LED พร้อม Light Bar", image: ledBack },
  { title: "ล้ออัลลอย 17 นิ้ว ทูโทน", image: wheels },
  { title: "ช่องชาร์จ AC Type 2", image: chargingPort },
  { title: "รองรับระบบ VtoL", image: chargingTool }
];
const INTERIOR_GALLERY = [
  { title: "ห้องโดยสารดีไซน์สองชั้น", image: premiumDesign },
  { title: "คอนโซลกลางควบคุมอัจฉริยะ", image: consoleImage },
  { title: "หน้าจอสัมผัส 12.8 นิ้ว", image: monitorImage },
  { title: "เบาะคู่หน้าปรับไฟฟ้า", image: seatImage },
  { title: "ที่วางแขนด้านหลังพร้อมที่วางแก้ว", image: armrestImage },
  { title: "ห้องเก็บสัมภาระด้านหลัง 450 ลิตร", image: storageImage }
];
const DIMENSIONS = [
  { label: "ความยาว (มม.)", value: "4,780" },
  { label: "ความกว้าง (มม.)", value: "1,837" },
  { label: "ความสูง (มม.)", value: "1,495" },
  { label: "ความกว้างล้อหน้า / หลัง (มม.)", value: "1,580 / 1,590" },
  { label: "ระยะฐานล้อ (มม.)", value: "2,718" },
  { label: "ความสูงใต้ท้องรถขณะบรรทุกเต็มพิกัด (มม.)", value: "120" },
  { label: "รัศมีวงเลี้ยวแคบสุด (ม.)", value: "5.5" },
  { label: "ความจุห้องเก็บสัมภาระด้านหลัง (ลิตร)", value: "450" }
];
const POWERTRAIN = [
  { label: "ระบบขับเคลื่อน", standard: "ขับเคลื่อนล้อหน้า", dynamic: "ขับเคลื่อนล้อหน้า", premium: "ขับเคลื่อนล้อหน้า" },
  {
    ...
    standard: "มอเตอร์ซิงโครนัสแม่เหล็กถาวร",
    dynamic: "มอเตอร์ซิงโครนัสแม่เหล็กถาวร",
    premium: "มอเตอร์ซิงโครนัสแม่เหล็กถาวร"
  },
...
const ENERGY = [
  ...
  { label: "รองรับชาร์จ AC Type 2 สูงสุด (กิโลวัตต์)", standard: "6.6", dynamic: "6.6", premium: "6.6" },
...
const SAFETY = [
  ...
  { label: "BSD (เตือนจุดอับสายตา)", standard: false, dynamic: false, premium: true },
  { label: "RCTA (เตือนรถตัดขณะถอยหลัง)", standard: false, dynamic: false, premium: true }
];
const MULTIMEDIA = [
...
function BydSeal5DmiBrochure({ model }) {
  ...
  const faqs = [
    { q: "BYD SEAL 5 DM-i ราคาเท่าไร?", a: "Standard 599,900 บาท · Dynamic 659,900 บาท · Premium 699,900 บาท" },
    { q: "วิ่งไฟฟ้าล้วนได้ไกลเท่าไร?", a: "รุ่น Standard/Dynamic 85 กม. และรุ่น Premium 120 กม. (NEDC)" },
    { q: "รองรับการชาร์จแบบไหนบ้าง?", a: "รองรับ AC Type 2 สูงสุด 6.6 kW และรุ่น Premium รองรับอุปกรณ์ VtoL" },
    { q: "ผ่อนเริ่มต้นเดือนละเท่าไร?", a: `ค่างวดเริ่มต้นประมาณ ${formatBaht(r.monthly)}/เดือน (ดาวน์ 20% ผ่อน 60 งวด)` }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative w-full min-h-[88vh] flex items-end overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full px-6 sm:px-12 lg:px-20 pb-16 pt-32", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-block rounded-full border border-primary/40 px-3 py-1 text-xs text-primary mb-4 backdrop-blur-sm bg-background/20", children: [
            "รถซีดานปลั๊กอินไฮบริด",
            " · DM-i Super PHEV"
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 180, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          { label: "กำลังรวม", val: "160 kW" },
          { label: "กำลังมอเตอร์", val: "145 kW" },
          { label: "แรงบิดมอเตอร์", val: "300 Nm" },
          { label: "0-100 กม./ชม.", val: "7.5 วินาที" },
          { label: "ระยะทางไฟฟ้า Premium", val: "120 km" }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-y border-border bg-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 140, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-3xl p-6 sm:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "ราคา", value: formatBaht(currentTrim.price) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "0-100 กม./ชม.", value: `${currentTrim.accel} ${"วินาที"}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "ระยะทางไฟฟ้า", value: `${currentTrim.evRange} km` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "แบตเตอรี่", value: currentTrim.battery }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: "มอเตอร์", value: currentTrim.motor })
      ] }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative w-full bg-black overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", style: { maxHeight: "80vh", aspectRatio: "16/9" }, children: [
      ...
      !videoPlaying && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center cursor-pointer", style: { background: "rgba(0,0,0,0.38)" }, onClick: () => {
        if (videoRef.current) {
          void videoRef.current.play();
          setVideoPlaying(true);
        }
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-20 w-20 rounded-full flex items-center justify-center transition-all hover:scale-105", style: {
          background: "rgba(255,255,255,0.15)",
          border: "2px solid rgba(255,255,255,0.4)",
          backdropFilter: "blur(6px)"
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-8 w-8 text-white fill-white ml-1" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-white text-lg font-semibold tracking-widest uppercase", children: "BYD SEAL 5 DM-i — วิดีโออย่างเป็นทางการ" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-surface/40 border-y border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: "* สี Harbour Grey มีเฉพาะรุ่น Premium" })
      ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 80, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 md:grid-cols-6 gap-3 mt-4", children: galleryItems.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveGallery(i), className: `relative overflow-hidden rounded-xl transition-all ${activeGallery === i ? "ring-2 ring-primary opacity-100" : "opacity-60 hover:opacity-90"}`, style: { aspectRatio: "16/10" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.image, alt: item.title, className: "w-full h-full object-cover" }) }, item.title)) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-y border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: contentImage, title: "UNLEASH YOUR IMAGINATION", subtitle: "งานดีไซน์แรงบันดาลจากท้องทะเล", body: "ดีไซน์สปอร์ตระดับพรีเมียมที่ได้แรงบันดาลจากท้องทะเล ถ่ายทอดทั้งความแข็งแกร่งและความลื่นไหลในทุกเส้นสาย", reverse: false, imageFullWidth: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: newMotorImage, title: "UNLEASH SUPER POWER", subtitle: "นวัตกรรมไฮบริด", body: "เทคโนโลยี DM-i Super PHEV ผสานมอเตอร์ไฟฟ้ากำลังสูงเข้ากับเครื่องยนต์ 1.5L เพื่อสมรรถนะและความประหยัดในการใช้งานทุกวัน", reverse: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: newCarImage, title: "DM-i Super PHEV", subtitle: "เทคโนโลยีหลัก", body: "ขับเคลื่อนด้วยความปลอดภัยของ BYD Blade Battery และระบบปลั๊กอินไฮบริดอัจฉริยะที่ตอบสนองฉับไว", reverse: false })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: "ข้อมูลทางเทคนิค" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: "สเปคทางเทคนิค" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleSpec, { title: "มิติและขนาดตัวรถ", icon: Ruler, rows: DIMENSIONS }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CompareSpec, { title: "ระบบขับเคลื่อนและสมรรถนะ", icon: Gauge, rows: POWERTRAIN }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "installment", className: "py-20 bg-surface/40 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: "แผนผ่อน BYD SEAL 5 DM-i" }) }) }),
...
function FeatureBlock({ img, title, subtitle, body, reverse, imageFullWidth = false }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col ${imageFullWidth ? "" : reverse ? "lg:flex-row-reverse" : "lg:flex-row"} items-stretch`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { className: imageFullWidth ? "w-full" : "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img, alt: title, className: imageFullWidth ? "block w-full h-auto object-contain" : "w-full object-cover", style: imageFullWidth ? void 0 : { height: "clamp(260px, 40vw, 520px)" } }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 100, className: `${imageFullWidth ? "w-full justify-center" : "flex-1"} flex items-center bg-surface/40`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-8 py-12 lg:px-14 lg:py-16 max-w-xl", children: [
...
function Cell({ value }) {
  if (value === true)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-5 w-5 text-primary mx-auto", "aria-label": "มีให้" });
  if (value === false)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-4 w-4 text-muted-foreground mx-auto", "aria-label": "ไม่มีให้" });
