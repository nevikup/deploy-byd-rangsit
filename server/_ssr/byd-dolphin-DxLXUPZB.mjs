...
import { l as SLUG$3, P as PageShell, k as heroBanner$1 } from "./router-B48uk9Ad.mjs";
...
import { a as getModel, c as calcInstallment, f as formatBaht, k as colorWhite$5 } from "./models-XtFHhd1I.mjs";
...
function BydDolphinBrochure({ model }) {
  ...
  const vehicleSchema = {
    ...
    offers: {
      ...
      seller: { "@type": "AutoDealer", name: "BYD จินหลง นครอินทร์" }
    }
  };
