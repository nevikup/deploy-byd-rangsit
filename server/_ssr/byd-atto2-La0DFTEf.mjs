...
import { o as SLUG$1, P as PageShell } from "./router-B48uk9Ad.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, n as colorSurgeWhite } from "./models-XtFHhd1I.mjs";
...
function BydAtto2Brochure({ model }) {
  ...
  const vehicleSchema = {
    ...
    offers: {
      ...
      seller: { "@type": "AutoDealer", name: "BYD Jinlong Nakhon In" }
    }
  };
